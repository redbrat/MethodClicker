...
public class ManyExposedThings : MonoBehaviour
{
    ...
    public MethodClickerPointer _Ressurect = new MethodClickerPointer() { BackgroundColor = Color.green, ButtonWidth = 120, ButtonHeight = 40, ButtonText = "<b>Ressurect!!!</b>" };
    ...
    public MethodClickerPointer Read_Text = new MethodClickerPointer() { BackgroundColor = Color.grey, FontStyle = FontStyle.Bold };
    ...
    public int Int2 = 2;
    public int Int3 = 3;
    public MethodClickerPointer Try____This____Value = new MethodClickerPointer() { BackgroundColor = Color.yellow };
    public int Int4 = 4;
    public int Int5 = 5;

    public void TrySome()
    {
        Debug.Log($"The value is {Int4} - it's very good...");
    }
